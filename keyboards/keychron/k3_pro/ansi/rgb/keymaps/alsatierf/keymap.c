...
[WIN_BASE] = LAYOUT_ansi_84(
     ...
     RALT_T(KC_ESC), KC_A, LALT_T(KC_S), LSFT_T(KC_D), LCTL_T(KC_F),     KC_G,     KC_H,     LCTL_T(KC_J), LSFT_T(KC_K), LALT_T(KC_L),     KC_SCLN,  KC_QUOT,            KC_ENT,             KC_HOME,
...
[WIN_FN] = LAYOUT_ansi_84(
     ...
     KC_CAPS,  KC_TRNS,  KC_TRNS,  OSM(MOD_LGUI),  KC_TRNS,  RGB_SPI,  KC_TRNS,  KC_HOME, KC_UP, KC_END, KC_DEL,  KC_TRNS,  KC_TRNS,  KC_TRNS,            KC_TRNS,
