...
[WIN_BASE] = LAYOUT_ansi_84(
     ...
     KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,            KC_PGUP,
     KC_TAB,   KC_Q,     KC_W,     LGUI_T(KC_E),     KC_R,     KC_T,     KC_Y,     KC_U,     LGUI_T(KC_I),     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,            KC_PGDN,
     LT(WIN_FN, KC_CAPS), KC_A, LALT_T(KC_S), LSFT_T(KC_D), LCTL_T(KC_F),     KC_G,     KC_H,     LCTL_T(KC_J), LSFT_T(KC_K), LALT_T(KC_L),     KC_SCLN,  KC_QUOT,            KC_ENT,             KC_HOME,
     KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,            KC_RSFT,  KC_UP,    KC_END,
...
[WIN_FN] = LAYOUT_ansi_84(
     ...
     KC_TRNS,  KC_TRNS,  KC_TRNS,  OSM(MOD_LGUI),  KC_TRNS,  RGB_SPI,  KC_TRNS,  KC_HOME, KC_UP, KC_END, KC_DEL,  KC_TRNS,  KC_TRNS,  KC_TRNS,            KC_TRNS,
     KC_TRNS,  KC_TRNS,  OSM(MOD_LALT), OSM(MOD_LSFT), OSM(MOD_LCTL),  KC_TRNS,  KC_TRNS,  KC_LEFT, KC_DOWN, KC_RGHT, KC_BSPC,  KC_TRNS,            KC_TRNS,            KC_TRNS,
     KC_TRNS,            KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_PGUP, KC_PGDN,  KC_TRNS,  LLOCK,            KC_TRNS,  KC_TRNS,  KC_TRNS,
     KC_TRNS,  KC_TRNS,  KC_TRNS,                                KC_TRNS,                                KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS)
};
